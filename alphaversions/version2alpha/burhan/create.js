...
document.getElementById("hdr-under").addEventListener('click', function(){
  document.querySelector("h1").style.borderBottom = "1px solid black";
  header.splice(1,0, "\tborder-bottom: 1px solid black;\n");
});
document.getElementById("hdr-whole").addEventListener('click', function(){
  document.querySelector("h1").style.border = "1px solid black";
  header.splice(1,0, "\tborder: 1px solid black;\n");
...
document.getElementById("nav-under").addEventListener('click', function(){
  let a = document.querySelectorAll("nav a");
  for(let i = 0; i < a.length; i++){
    a[i].style.borderBottom = "1px solid black";
  }
  nav.splice(1,0, "\tborder-bottom: 1px solid black;\n");

});
document.getElementById("nav-whole").addEventListener('click', function(){
  let a = document.querySelectorAll("nav a");
  for(let i = 0; i < a.length; i++){
    a[i].style.border = "1px solid black";
  }
  nav.splice(1,0, "\tborder: 1px solid black;\n");
});
...
// __________________________Main Border Under______________________________________
document.getElementById("border-hln-under").addEventListener('click', function(){
  document.querySelector("h2").style.borderBottom = "1px solid black";
  
});
document.getElementById("border-hln-whole").addEventListener('click', function(){
  document.querySelector("h2").style.border = "1px solid black";
});
